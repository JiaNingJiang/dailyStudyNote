...
![image-20221225185304687](14.HTML嵌入CSS样式.assets/image-20221225185304687.png)

在上面示例中，行内样式由 HTML 元素的 style 属性嵌入，即**将 CSS 代码放入`style=""`引号内即可**，**多个 CSS 属性值则通过分号`;`间隔**。例如示例中的 <div> 标签：
...
![image-20221225185909199](14.HTML嵌入CSS样式.assets/image-20221225185909199.png)
...
![image-20221225190222707](14.HTML嵌入CSS样式.assets/image-20221225190222707.png)
...
![image-20221225192130426](14.HTML嵌入CSS样式.assets/image-20221225192130426.png)
...
![image-20221225192903370](14.HTML嵌入CSS样式.assets/image-20221225192903370.png)
